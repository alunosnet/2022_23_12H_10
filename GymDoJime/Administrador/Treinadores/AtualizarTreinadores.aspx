<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMestra.Master" AutoEventWireup="true" CodeBehind="AtualizarTreinadores.aspx.cs" Inherits="GymDoJime.Administrador.Treinadores.AtualizarTreinadores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
       ...
       <asp:Button runat="server" ID="btRegistar"
        ...
        <asp:Button runat="server" ID="btVoltar" CssClass="btn btn-outline-danger float-rigth" Text="Voltar" OnClick="btVoltar_Click" />
