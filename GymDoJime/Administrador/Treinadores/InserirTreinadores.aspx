<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMestra.Master" AutoEventWireup="true" CodeBehind="InserirTreinadores.aspx.cs" Inherits="GymDoJime.Administrador.Treinadores.InserirTreinadores" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView ID="dgvTreinadores" runat="server" CsSClass="table"/>
    <h1>Registo</h1>
