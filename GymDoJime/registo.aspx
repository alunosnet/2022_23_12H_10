<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMestra.Master" AutoEventWireup="true" CodeBehind="registo.aspx.cs" Inherits="GymDoJime.registo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div runat="server" class="form-group" id="divLogin">
        ...
        <div class="form-group">
            ...
            <asp:ListItem Text="Masculino" Value="0"/>
